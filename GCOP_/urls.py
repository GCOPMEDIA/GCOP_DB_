...
urlpatterns = [
    ...
    path(
        "survivor_details/<int:survivor_index>/",
        survivor_details_view,
        name="survivor_details",
    ),
    path("form_success/", form_success_view, name="form_success"),
    path("spouse_details", spouse_details, name="spouse_details"),
    path(
        "members-without-images/", members_without_images, name="members_without_images"
    ),
    path(
        "upload-member-image/<int:member_id>/",
        upload_member_image,
    ...
    path(
        "users_search_view/<f_name>/<l_name>/<phone_num>",
        users_search_view,
        name="users_search_view",
    ),
    ...
    path(
        "attendance-today-mercy-temple/",
        attendance_mercy_temple,
        name="attendance-mercy-temple",
    ),
    path(
